...
<template>
	<div class="content">
		...
		<hr>
		<div class="friends">
			<div v-for="friend in clientData.data.friends" :key="friend.username" class="row">
				<div class="col-1"><img width="64px" height="64px" src="@/assets/testIcon.jpg"></div><div class="col-4">Username</div>
			</div>
		</div>
	</div>
</template>
